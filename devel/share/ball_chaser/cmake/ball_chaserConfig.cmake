...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /home/robond/Chaser/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /home/robond/Chaser/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/robond/Chaser/install)
...
if(NOT "/home/robond/Chaser/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/home/robond/Chaser/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/Chaser/src/ball_chaser/${idir}'.  Ask the maintainer 'robond <robond@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robond/Chaser/devel/lib;/opt/ros/kinetic/lib)
